...
- **GIF形式、PNG形式、またはWebP形式としてください。**
- **またWebPであれば40KB以内、WebP以外の静止画であれば50KB以内、GIFアニメーションであれば110KB以内を目安にサイズを調整して下さい。**
- JPEGは絵文字としてはRejectします。ご注意ください
   - **Safariなど一部ブラウザ**では、画像は**圧縮: なし**でアップロードしてください  
     Misskeyの機能により自動でJPEGに変換されてしまいます。
- 運営により圧縮・加工が行われる場合がある事をご了承下さい
